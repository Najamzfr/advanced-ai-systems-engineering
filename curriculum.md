...
# PROJECT 2
# Autonomous Market Intelligence & Risk Operations Platform

Project duration:

**Weeks 5–8**

This project should be a realistic, differentiated system combining:
...
A financial institution wants to continuously monitor:
...
1. detect unusual events
2. investigate them
3. retrieve evidence
4. perform deterministic calculations
5. verify conclusions
6. escalate only meaningful events
...
Implement non-LLM calculations:
...
2. search filings
3. inspect news
4. retrieve historical analogues
5. collect evidence

It should not conclude prematurely.
...
It should not perform narrative speculation.

---

### Stage 8 — Risk Verifier
...
Also support event-driven runs.

---

### Stage 11 — Evaluation Dataset
...
No paid cloud should be required.
...
│   └── Project 02 — Market Intelligence Platform
│
├── Reading
├── Progress
└── About
