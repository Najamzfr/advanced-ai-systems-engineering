...
MIN_CASES = 50
REQUIRED_METRICS = ["attack success rate","benign task success","unauthorized tool-call rate","false refusal rate","recovery rate"]
...
def checks():
    ...
    artifact = ROOT/'reports/red_team_report.json'
    report_checks = {
